...
namespace Eksin_EczaneOtomasyonProject
{
    ...
    public partial class EksinPharmaDatabaseEntitiesCodex : DbContext
    {
        public EksinPharmaDatabaseEntitiesCodex()
            : base("name=EksinPharmaDatabaseEntitiesCodex")
        {
        }
        ...
        public virtual DbSet<StokSiparisleri> StokSiparisleri { get; set; }
